...
public class CGPA18 {
	...
	private void initialize() {
		...
		btnCalculate.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if(s3==0.0&&s4==0.0&&s5==0.0&&s6==0.0 && s7==0.0 && s8==0.0 ) {
					...
					Double c = Double.valueOf(cgpa);
					float cg = c.floatValue();
					...
					double cgpa = (20.0*s1+20.0*s2+24.0*s3+24.0*s4+25*s5+24*s6+20*s7+18*s8)/175.0;
					double percentage = (cgpa-0.75)*10.0;
					Double c = Double.valueOf(cgpa);
					float cg = c.floatValue();
					Double d = Double.valueOf(percentage);
		...
		lblPleaseEnterThe.setBounds(214, 11, 305, 14);
